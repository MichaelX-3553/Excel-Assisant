...
!(function (e, t) {
	...
	'use strict';
	var f =
		'undefined' != typeof self ? self : 'undefined' != typeof window ? window : void 0 !== f ? f : {};
				...
				if (
					...
					var r = (function () {
						...
						var e =
								...
								(r = s.toString()),
								b.BLOB_URL ||
									(b.BLOB_URL = i.createObjectURL(new Blob(['(', r, ')();'], { type: 'text/javascript' })))),
							t = new f.Worker(e);
						var i, r;
			...
			unparse: function (e, t) {
				...
				!(function () {
					...
					('boolean' == typeof t.escapeFormulae || t.escapeFormulae instanceof RegExp) &&
						(o = t.escapeFormulae instanceof RegExp ? t.escapeFormulae : /^[=+\-@\t\r].*$/);
				})();
					...
					for (var o = 0; o < t.length; o++) {
						...
						if (
							(i &&
								!n &&
								(u =
									'greedy' === i ? '' === t[o].join('').trim() : 1 === t[o].length && 0 === t[o][0].length),
							'greedy' === i && n)
						) {
							for (var d = [], l = 0; l < h; l++) {
								var c = s ? e[l] : l;
			...
			return (
				this.each(function (e) {
					...
					for (var t = 0; t < this.files.length; t++)
						h.push({ file: this.files[t], inputElem: this, instanceConfig: d.extend({}, i) });
				}),
				e(),
				this
			);
		...
		(this._handle = null),
			...
			(this.parseChunk = function (e, t) {
				...
				if (!this._handle.paused() && !this._handle.aborted()) {
					var s = n.meta.cursor;
					this._finished ||
						((this._partialLine = r.substring(s - this._baseIndex)), (this._baseIndex = s)),
			...
			(this._sendError = function (e) {
				M(this._config.error)
					...
					: o && this._config.error && f.postMessage({ workerId: b.WORKER_ID, error: e, finished: !1 });
			});
	}
	function l(e) {
		var r;
			...
			(this._readChunk = function () {
				if (this._finished) this._chunkLoaded();
					...
					if (
						...
						this._config.withCredentials && (r.withCredentials = this._config.withCredentials),
						n || ((r.onload = v(this._chunkLoaded, this)), (r.onerror = v(this._chunkError, this))),
						r.open(this._config.downloadRequestBody ? 'POST' : 'GET', this._input, !n),
			...
			(this._chunkLoaded = function () {
				4 === r.readyState &&
					(r.status < 200 || 400 <= r.status
						? this._chunkError()
						: ((this._start += this._config.chunkSize ? this._config.chunkSize : r.responseText.length),
						  (this._finished =
		...
		u.call(this, (e = e || {})),
			...
			(this._nextChunk = function () {
				if (!this._finished) {
					...
					return (
						t ? ((e = i.substring(0, t)), (i = i.substring(t))) : ((e = i), (i = '')),
						(this._finished = !i),
						this.parseChunk(e)
					);
				}
	...
	function i(m) {
					...
					function e(e, t) {
						...
						for (i = 0; i < e.length; i++) {
							...
							m.header && (n = i >= l.length ? '__parsed_extra' : l[i]),
								...
								(s = v(n, s)),
								'__parsed_extra' === n ? ((r[n] = r[n] || []), r[n].push(s)) : (r[n] = s);
						}
						return (
							m.header &&
								(i > l.length
									? k(
											'FieldMismatch',
											'TooManyFields',
											'Too many fields: expected ' + l.length + ' fields but parsed ' + i,
											f + t
									  )
									: i < l.length &&
									  k(
											'FieldMismatch',
											'TooFewFields',
											'Too few fields: expected ' + l.length + ' fields but parsed ' + i,
											f + t
									  )),
							r
						);
		...
		(this.parse = function (e, t, i) {
			...
			if (
				...
				M(m.delimiter) && ((m.delimiter = m.delimiter(e)), (c.meta.delimiter = m.delimiter));
			else {
				var n = (function (e, t, i, r, n) {
					...
					for (var u = 0; u < n.length; u++) {
						...
						o = void 0;
						for (
							var p = new E({ comments: r, delimiter: f, newline: t, preview: 10 }).parse(e), g = 0;
							g < p.data.length;
							g++
						)
							if (i && y(p.data[g])) c++;
				...
				n.successful ? (m.delimiter = n.bestDelimiter) : ((h = !0), (m.delimiter = b.DefaultDelimiter)),
		...
		(this.parse = function (r, t, i) {
			...
			function C(e) {
				return {
					data: h,
					errors: u,
					meta: { delimiter: O, linebreak: x, aborted: z, truncated: !!e, cursor: d + (t || 0) },
				};
			}
			function R() {
				T(C()), (h = []), (u = []);
		...
		if (t.error) i.userError(t.error, t.file);
			...
			if (M(i.userStep)) {
				for (
					...
					(i.userStep({ data: t.results.data[s], errors: t.results.errors, meta: t.results.meta }, n),
					!r);
					s++
				);
				delete t.results;
		...
		o &&
			(f.onmessage = function (e) {
				...
				if ('string' == typeof t.input)
					f.postMessage({ workerId: b.WORKER_ID, results: b.parse(t.input, t.config), finished: !0 });
				else if ((f.File && t.input instanceof File) || t.input instanceof Object) {
					var i = b.parse(t.input, t.config);
					i && f.postMessage({ workerId: b.WORKER_ID, results: i, finished: !0 });
				}
			}),
